...
<html lang="pt-br" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Descubra Portugal | Cadastro </title>
  </head>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
  ...
  <main class="form-signin w-100 m-auto">
    <form action="gravar.php" method="POST">
      <img class="mb-4" src="../img/svg/coat_of_arms.svg" alt="Brasão de Armas" width="70" height="70">
      ...
      <!-- <div class="form-check text-start my-3"> -->
        <!-- <input class="form-check-input" type="checkbox" value="Lembre-se de mim" id="flexCheckDefault"> -->
      ...
      <p class="mt-5 mb-3 text-body-secondary">&copy; João Paulo Souza Bernucio</p>
    </form>
  </main>
